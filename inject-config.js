...
(async () => {
  ...
  const settings = {
    ...
    // PayPal手机验证池
    hostedSmsPool: `16562710160----https://smscc.985008.xyz/smsrecord?token=PLe012fe3de6ff1d7387cac2ee31b5a8b7
16562689508----https://smscc.985008.xyz/smsrecord?token=PLd82581ee0b1902fb72f0528ca13b80fb`,
    hostedCheckoutPhone: '16562710160',
    
    // 代理
    ipProxyEnabled: false,  // 使用mihomo系统代理
    
    // Helper
    gpcHelperApi: 'http://127.0.0.1:17373',
    
    // 自动运行
    operationDelayEnabled: true,
    autoSkipFailures: true,
    phoneReplacementLimit: 3,
